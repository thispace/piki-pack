...
class PikiForms_ctype extends PikiForms {
    ...
    public static function init(){
        ...
        $args = array(
            ...
            'show_ui'               => true, 
            'show_in_menu'          => false,
            'menu_icon'             => plugins_url( '/images/piki-icon.png' , __FILE__ ),
    ...
    public static function render_formfields( $post ){
        ...
        wp_enqueue_script( 'formfields-script', plugins_url( '/' , __FILE__ ) . '/includes/formfields.js', array( 'jquery' ) );
        wp_enqueue_style( 'formfields-css', plugins_url( '/' , __FILE__ ) . 'includes/formfields.css' );
    }
