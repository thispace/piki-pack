...
class PikiMedia {
	...
	public static function register_post_types(){
	    ...
	    $args = array(
	        ...
	        'menu_icon' => plugins_url( '/images/photos-icon.png' , __FILE__ )
	    );      
	    ...
	    $args = array(
	        ...
	        'menu_position' => 5,
	        'supports' => array( 'title' ),
	        'menu_icon' => plugins_url( '/images/videos-icon.png' , __FILE__ )
	    );      
	    ...
	    $args = array(
	        ...
	        'menu_position' => 5,
	        'supports' => array( 'title' ),
	        'menu_icon' => plugins_url( '/images/audios-icon.png' , __FILE__ )
	    );      
