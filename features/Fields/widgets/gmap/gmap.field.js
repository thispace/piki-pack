(function($){
	...
	var GMFMethods = {
		...
		init : function( data ) {
			...
			// Carregando API
			//if( !gmap_load_api ){
			//	console.log( 'Não foi possível carregar a API do Google Maps.' )
			//	return;
			//}
	  	...
	  	configure : function( data ){
			...
			data.user_mark = new google.maps.Marker({
	            map: data.map,
	            draggable : true,
		...
		return this.each(function(){
			...
			if( data === undefined ){
				...
				var defaults = {
					...
					// BARRA DE ZOOM 
					zoom : { min : 4, max : 16, init : 4, search : 13 },
					scrollwhell : false,

					// LOCALIZAÇÃO INICIAL
					initials : { lat: -14.264383, lng: -51.943359 },
